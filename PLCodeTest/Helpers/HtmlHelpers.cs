...
namespace PLCodeTest.Helpers
{
	public static class HtmlHelpers
	{
		public static IHtmlString RemoveControlLink(this HtmlHelper htmlHelper, string linkText, string container, string deleteElement)
		{
